  ...
  return (
    <section className="w-full max-w-full flext-start flex-col">
      ...
      <form
        ...
        className="mt-10 w-full max-w-2xl flex flex-col gap-7 bg_prompt"
      >
        <label>
        ...
        <div className="flex-end mx-3 mb-5 gap-4">
          ...
          <button type='submit' disabled={submitting} className="px-5 py-1.5 text-sm bg-slate-600 hover:bg-slate-700 rounded-full text-white font-medium" >
            Post
          </button>
